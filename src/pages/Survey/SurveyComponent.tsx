...
export default function SurveyComponent() {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className={`flex flex-col items-center ${id !== "16" && "justify-center"} mt-16 mb-16 min-h-screen px-4 gap-32`}
    >
      ...
      <div className={`flex flex-col ${id !== "16" && "w-[20%]"} justify-center gap-4 w-[100%]`}>
        {!(id === "16" && results)
